...
if($search_tag == "name") {
    $tag_name = "작성자";
}else if($search_tag == "title") {
    $tag_name = "제목";
}else if($search_tag == "sub") {
    $tag_name = "내용";
}
    ...
    <div class="board_list">
        ...
        <div class="list-page-btns">
            ...
            if($n_page > 0) {
                ...
                $link = "<button class='btn'><a href='/board/category?idx=".$tag."&start=${p_start}&tag=${search_tag}&contain=${contain}'>";
                $link .= "Prev";
                $link .= "</a></button>";
                echo $link." ";
            }
            ...
            for($i=$is; $i < $is+$page_scale; $i++){
                    ...
                    if($i < $total_page){
                    $link = "<button class='btn'><a href='/board/category?idx=".$tag."&start=${i}&tag=${search_tag}&contain=${contain}'>";
                    $link .= $i+1;
                    $link .= "</a></button>";
                    echo $link." ";
                }
